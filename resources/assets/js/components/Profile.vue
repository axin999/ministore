    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-header bg-black" style="background-image:url('./img/profile-cover.jpg'); height: 250px;">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="inputFilePhoto">Profile Photo</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" @click.prevent="updadateInfo" class="btn btn-success">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
